function wipattention(Z::Array{T,2},Weights::Vector{Float64};
    ...
    parameters, pslike, elapstime, numevals= wipminimize_pl(plmalg, plmvar,initx0=initx0)
...
function wipattention(filename::String;
    ...
    wipattention(Z, Weights; kwds...)
end

function wipminimize_pl(alg::PlmAlg, var::AttPlmVar;
    ...
    min_objective!(opt, (x, g) -> wipoptimfunwrapper(g,x, var))
...
function wippl_and_grad!(grad::Vector{Float64}, x::Vector{Float64}, plmvar::AttPlmVar)
    ...
    # Threads.@threads for site in 1:N 
    #     wipupdate_K_site!(grad, Q, V, site, λ, data.sf, data.J, data.fact)
    # end

    wipupdate_V!(grad, Q, V, λ, data)
...
# function wipupdate_Q_site!(grad::Vector{Float64}, Z::Array{Int,2}, Q::Array{Float64,3}, K::Array{Float64,3}, V::Array{Float64,3}, site::Int, weights::Vector{Float64}, lambda::Float64, data::AttComputationQuantities, delta, wdelta)
...
# function wipupdate_K_site!(grad::Vector{Float64}, Q::Array{Float64,3}, V::Array{Float64,3}, site::Int, lambda::Float64, sf::Array{Float64,3}, J::Array{Float64,4}, fact::Array{Float64,3}) 
#     H,d,N = size(Q)
#     _,q,_ = size(V)
...
function wipupdate_QK_site!(grad::Vector{Float64}, Z::Array{Int,2}, Q::Array{Float64,3}, K::Array{Float64,3}, V::Array{Float64,3}, site::Int, weights::Vector{Float64}, lambda::Float64, data::AttComputationQuantities, delta, wdelta)
...
function wipupdate_V!(grad::Vector{Float64}, Q::Array{Float64,3}, V::Array{Float64,3}, lambda::Float64, data::AttComputationQuantities)
...
function wipoptimfunwrapper(g::Vector,x::Vector, var::AttPlmVar)
